...
# from data_provider import dataset_common

VOC_LABELS_needed_8piece = {
    'none': (0, 'Background'),
    'car': (1, 'car'),
    'truck':(2,'truck'),
    'bus': (3, 'bus'),
...
def gain_translate_table():
    label2name_table = {}
    for class_name, labels_pair in VOC_LABELS_needed_8piece.items():
